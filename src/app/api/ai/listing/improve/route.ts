...
import { improveListingDescription, AiUnsafeOutputError } from "@/lib/ai/listing-generators";
import { isAiConfigured, AiNotConfiguredError, AiRequestError } from "@/lib/ai/client";

const MAX_INPUT = 4000;

// POST /api/ai/listing/improve — improve an advertiser listing description
export async function POST(request: Request) {
  try {
    ...
    const result = await improveListingDescription(content);
    ...
    logError(error, { component: "route:api/ai/listing/improve" });
