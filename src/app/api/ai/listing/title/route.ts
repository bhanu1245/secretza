...
import { generateListingTitle, AiUnsafeOutputError } from "@/lib/ai/listing-generators";
import { isAiConfigured, AiNotConfiguredError, AiRequestError } from "@/lib/ai/client";

// POST /api/ai/listing/title — generate an advertiser listing title
export async function POST(request: Request) {
  try {
    ...
    logError(error, { component: "route:api/ai/listing/title" });
