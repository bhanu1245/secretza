...
import { generateSeoDescription, AiUnsafeOutputError } from "@/lib/ai/seo-generators";
import { isAiConfigured, AiNotConfiguredError, AiRequestError } from "@/lib/ai/client";

// POST /api/ai/seo/description — generate an SEO description from context
export async function POST(request: Request) {
  try {
    ...
    logError(error, { component: "route:api/ai/seo/description" });
