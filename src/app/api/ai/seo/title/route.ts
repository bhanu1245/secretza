...
import { generateSeoTitle, AiUnsafeOutputError } from "@/lib/ai/seo-generators";
import { isAiConfigured, AiNotConfiguredError, AiRequestError } from "@/lib/ai/client";

// POST /api/ai/seo/title — generate an SEO title from listing/page context
export async function POST(request: Request) {
  try {
    ...
    logError(error, { component: "route:api/ai/seo/title" });
