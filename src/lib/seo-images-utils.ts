/**
 * Browser-safe SEO image helpers (no filesystem / storage dependencies).
 */
...
export function serializeSeoPageImages(
  page: SeoImageFields & { title?: string | null; h1?: string | null; pageType?: string },
) {
