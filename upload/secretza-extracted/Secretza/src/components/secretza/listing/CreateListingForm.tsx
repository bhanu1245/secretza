...
export default function CreateListingForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/listings?XTransformPort=3000", {
        method: "POST",
      ...
      if (!res.ok) {
        const errorMsg = data.error || "Failed to create listing. Please try again.";
    ...
    return (
      <div className="mx-auto flex max-w-lg flex-col items-center rounded-xl border border-[rgba(255,255,255,0.08)] bg-surface p-8 text-center">
        ...
        <p className="mb-6 text-sm text-[#A1A1AA]">
          Your listing is now pending review. We&apos;ll notify you once
          it&apos;s approved and live. This usually takes less than 24 hours.
        </p>
        <Button
    ...
    <div className="mx-auto w-full max-w-2xl">
      ...
      <div className="mb-8">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-bold text-[#F5F5F7]">Create Listing</h2>
