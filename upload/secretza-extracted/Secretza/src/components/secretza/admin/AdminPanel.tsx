...
import { adminStats, formatNumber } from "@/lib/mock-data";
...
// ==========================================
const revenueData = [
  { month: "Jan", revenue: 28500, listings: 820 },
  { month: "Feb", revenue: 32100, listings: 910 },
  { month: "Mar", revenue: 29800, listings: 870 },
  { month: "Apr", revenue: 35200, listings: 1020 },
  { month: "May", revenue: 38400, listings: 1100 },
  { month: "Jun", revenue: 42350, listings: 1180 },
  { month: "Jul", revenue: 39100, listings: 1050 },
  { month: "Aug", revenue: 44800, listings: 1240 },
];

const mockAdminUsers: (User & { listings: number })[] = [
  { id: "au-1", email: "sophia@email.com", name: "Sophia Chen", avatar: null, role: "user", isVerified: true, isSuspended: false, isPremium: true, premiumExpiry: "2025-12-31", provider: "email", createdAt: "2024-03-15T10:00:00Z", listings: 12 },
  { id: "au-2", email: "emma.w@email.com", name: "Emma Wilson", avatar: null, role: "user", isVerified: true, isSuspended: false, isPremium: false, premiumExpiry: null, provider: "google", createdAt: "2024-05-22T14:30:00Z", listings: 5 },
  { id: "au-3", email: "isabella@email.com", name: "Isabella Rossi", avatar: null, role: "moderator", isVerified: true, isSuspended: false, isPremium: false, premiumExpiry: null, provider: "email", createdAt: "2024-01-10T08:00:00Z", listings: 0 },
  { id: "au-4", email: "olivia@email.com", name: "Olivia Brown", avatar: null, role: "user", isVerified: false, isSuspended: false, isPremium: false, premiumExpiry: null, provider: "email", createdAt: "2024-07-01T16:00:00Z", listings: 2 },
  { id: "au-5", email: "ava.m@email.com", name: "Ava Martinez", avatar: null, role: "user", isVerified: true, isSuspended: true, isPremium: false, premiumExpiry: null, provider: "email", createdAt: "2024-04-18T12:00:00Z", listings: 8 },
  { id: "au-6", email: "victoria@email.com", name: "Victoria Lee", avatar: null, role: "user", isVerified: true, isPremium: true, isSuspended: false, premiumExpiry: "2025-09-30", provider: "google", createdAt: "2024-02-28T09:00:00Z", listings: 15 },
  { id: "au-7", email: "luna@email.com", name: "Luna Kim", avatar: null, role: "user", isVerified: true, isSuspended: false, isPremium: true, premiumExpiry: "2025-11-15", provider: "email", createdAt: "2024-06-05T11:00:00Z", listings: 7 },
  { id: "au-8", email: "chloe@email.com", name: "Chloe Davis", avatar: null, role: "admin", isVerified: true, isSuspended: false, isPremium: false, premiumExpiry: null, provider: "email", createdAt: "2023-12-01T08:00:00Z", listings: 3 },
  { id: "au-9", email: "mia@email.com", name: "Mia Johnson", avatar: null, role: "user", isVerified: false, isSuspended: false, isPremium: false, premiumExpiry: null, provider: "email", createdAt: "2024-08-12T14:00:00Z", listings: 1 },
  { id: "au-10", email: "aria@email.com", name: "Aria Patel", avatar: null, role: "user", isVerified: true, isSuspended: false, isPremium: false, premiumExpiry: null, provider: "google", createdAt: "2024-07-20T10:00:00Z", listings: 4 },
];
...
function AdminDashboardPage() {
  const statsCards = [
    { label: "Total Users", value: formatNumber(adminStats.totalUsers), change: "+12.5%", icon: Users, color: "#7C3AED", bg: "rgba(124,58,237,0.1)" },
    { label: "Total Listings", value: formatNumber(adminStats.totalListings), change: "+8.2%", icon: FileText, color: "#3B82F6", bg: "rgba(59,130,246,0.1)" },
    { label: "Active Listings", value: formatNumber(adminStats.activeListings), change: "+5.1%", icon: TrendingUp, color: "#10B981", bg: "rgba(16,185,129,0.1)" },
    { label: "Pending Review", value: adminStats.pendingReview.toString(), change: "+3", icon: Clock, color: "#F59E0B", bg: "rgba(245,158,11,0.1)" },
    { label: "Total Revenue", value: `$${formatNumber(adminStats.totalRevenue)}`, change: "+18.3%", icon: DollarSign, color: "#10B981", bg: "rgba(16,185,129,0.1)" },
  ];
        ...
        <Card className="bg-[#15151D] border-[rgba(255,255,255,0.08)]">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-xs text-[#A1A1AA]">
              {adminStats.pendingReview} items pending review
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 pt-2">
            {pendingItems.map((item, i) => (
              <div key={i} className="flex items-start gap-3 p-2.5 rounded-lg bg-[#1E1E2A] border border-[rgba(255,255,255,0.04)]">
                <img
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-[#F5F5F7] truncate">{item.listing.title}</p>
                  <p className="text-[10px] text-[#A1A1AA] mt-0.5">{item.issues.length} issues</p>
                </div>
                <Badge
                  variant="outline"
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#A1A1AA] mt-1">
            {formatNumber(adminStats.totalUsers)} total users
          </p>
        </div>
